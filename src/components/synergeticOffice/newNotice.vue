                        ...
                        <ul>
                            <li v-for="(item,index) in items" :key="index" :class="{tipnew: item.new}">
                                ...
                                <div class="clearfix bottom-content">
                                    <div class="lf w75">
                                        <p class="clearfix">
                                            <span class="lf">{{item.department}}</span>
                                            <span class="lf">{{item.name}}</span>
                                            <span class="lf">{{item.data}}</span>
                                            <span class="lf">{{item.times}}</span>
                                            <span class="lf">板块：{{item.plate}}</span>
                                        </p>
                                    </div>
                                    <div class="rf">
                                        <div class="clearfix">
                                    ...
                                    <ul>
                                       <li>
                                           <div class="clearfix">
                                                ...
                                                <span class="lf selet firstsels" :class="{selected:firstselect}" @click="allshow($event)" :id="id"></span>
                                           ...
                                           <ul class="secondTit">
                                               <li class="departments" v-for="(item,index) in departmentmsg" :key="index" >
                                                    <div class="clearfix firstdepart">
                                                        <span class="lf arrows"></span>
                                                        <span class="lf selet" :class="{selected:item.isselect}" @click="selectfn(index)" :id="item.id"></span>
...
<style scoped>
    ...
    .wrap-notice .top-content h3{ font-size: .16rem;font-weight:100}
